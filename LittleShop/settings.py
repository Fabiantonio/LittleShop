"""
Django settings for LittleShop project.
...
WSGI_APPLICATION = 'LittleShop.wsgi.application'
...
DATABASES = {
    'default': dj_database_url.config(
        default="postgresql://postgres:cNJZSYVUzOTjPPwLXnQZIpphvGQYjrcs@autorack.proxy.rlwy.net:52477/railway"
    )
}
